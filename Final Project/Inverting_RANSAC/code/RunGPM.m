...
gtDists =     sqrt( (GT_targetCornerXs(indsSource) - GT_targetCornerXs(indsTarget)).^2 + ...
    (GT_targetCornerYs(indsSource) - GT_targetCornerYs(indsTarget)).^2   );% Measure distance matrix of corners
[GTminScale,GTmaxScale] = bounds2(gtDists./sourceDists);  % min max of gtDists./sourceDists
