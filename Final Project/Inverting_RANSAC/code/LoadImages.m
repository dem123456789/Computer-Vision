...
switch name
    ...
    case 'graffiti_viewpoint_frames_1_2';
        fileName1 = fullfile(pthData,'miko\graffiti_viewpoint\img1.bmp');
        fileName2 = fullfile(pthData,'miko\graffiti_viewpoint\img2.bmp');
        GT_homog = dlmread(fullfile(pthData,'miko\graffiti_viewpoint\H1to2p'));
%         useprctile = 75;
        scaleFact = 2;
